<template>
  <div id="manager">
    <h1 style="background-color: rgb(238, 241, 246)">管理员菜单</h1>
    <el-container>
      <el-aside width="150px" style="background-color: rgb(238, 241, 246)">
        <el-tabs v-model="selectedValue" tab-position="left" stretch="true" @tab-click="getall()">
          <el-tab-pane v-for="table in tables" :label="table.label" :name="table.value" :key="table.id">
          </el-tab-pane>
        </el-tabs>
      </el-aside>
      <el-main>
        <el-row :gutter="20">
          <el-col :span='24'>
            ...
            <el-form v-if="selectedValue == 'student'">
              ...
              <el-row type="flex">
                <el-row :gutter="20">
                  <el-form ref="elForm" v-if="selectedValue == 'student'" size="small" label-width="93px">
                    <el-col :span="11">
                    ...
                    <el-col :span="11" v-if="studentselect == 'select' || studentselect == 'delete'">
        ...
        <el-row>
          <el-col :span='24'><el-table :data="info" height="500" style="width: 100%">
              <template v-for="item in tableForList">
                <el-table-column :prop="item.value" :label="item.label" sortable v-if="item.isshow">
                </el-table-column>
              </template>
            </el-table></el-col>
        </el-row>
...
export default {
  data() {
    return {
      ...
      tableForGet: [
        {
          url: "http://localhost:3000/manager/getstudent",
          list: [0, 4, 5, 6, 7, 8, 14],
        },
        {
          url: "http://localhost:3000/manager/getteacher",
          list: [3, 4, 5, 6, 9, 10, 14],
        },
        {
          url: "http://localhost:3000/manager/getcourse",
          list: [2, 11, 12, 13, 14],
        },
        {
          url: "http://localhost:3000/manager/getdepartment",
          list: [14, 15, 16, 17],
        },
        {
          url: "http://localhost:3000/manager/getselection",
          list: [0, 1, 2, 3, 18, 19, 20],
        },
  ...
  methods: {
    ...
    getall() {
      ...
      if (this.selectedValue == "student") {
        this.getdata(this.tableForGet[0].url, this.tableForGet[0].list);
      } else if (this.selectedValue == "teacher") {
        this.getdata(this.tableForGet[1].url, this.tableForGet[1].list);
      } else if (this.selectedValue == "course") {
        this.getdata(this.tableForGet[2].url, this.tableForGet[2].list);
      } else if (this.selectedValue == "department") {
        this.getdata(this.tableForGet[3].url, this.tableForGet[3].list);
      } else if (this.selectedValue == "selection") {
        this.getdata(this.tableForGet[4].url, this.tableForGet[4].list);
      } else if (this.selectedValue == "class") {
        this.getdata(this.tableForGet[5].url, this.tableForGet[5].list);
      }
    ...
    changestudentkey() {
      ...
      axios
        .get("http://localhost:3000/manager/changestudentkey", {
          params: {
            id: this.studentid,
            newkey: this.tempkey,
          },
    ...
    changeteacherkey() {
      console.log(this.studentdate);
      axios
        .get("http://localhost:3000/manager/changeteacherkey", {
          params: {
            id: this.staffid,
            newkey: this.tempkey,
          },
    ...
    getstudent() {
      //查询单个学生
      axios
        .get("http://localhost:3000/manager/getonestudent", {
    ...
    deletestudent() {
      //删除单个学生操作
      axios
        .get("http://localhost:3000/manager/delonestudent", {
          params: { id: this.studentid },
        })
        .then((res) => {
          console.log(res.data);
    ...
    addstudent() {
      ...
      if (
        ...
        console.log(this.studentdate);
        axios
          .get("http://localhost:3000/manager/addonestudent", {
            params: {
              id: this.studentid,
              sex: this.studentsex,
    ...
    updatestudent() {
      //修改学生操作
      axios
        .get("http://localhost:3000/manager/updatestudent", {
          params: {
            id: this.studentid,
            sex: this.studentsex,
            name: this.studentname,
    ...
    getteacher() {
      //查询单个老师
      axios
        .get("http://localhost:3000/manager/getoneteacher", {
    ...
    deleteteacher() {
      //删除单个老师操作
      axios
        .get("http://localhost:3000/manager/deloneteacher", {
          params: { id: this.staffid },
        })
        .then((res) => {
          console.log(res.data);
    ...
    addteacher() {
      ...
      if (
        ...
        axios
          .get("http://localhost:3000/manager/addoneteacher", {
            params: {
              id: this.staffid,
              sex: this.teachersex,
    ...
    updateteacher() {
      //修改教师操作
      axios
        .get("http://localhost:3000/manager/updateteacher", {
          params: {
            id: this.staffid,
            sex: this.teachersex,
            name: this.teachername,
    ...
    addcourseinfo() {
      ...
      if (
        ...
        axios
          .get("http://localhost:3000/manager/addcourseinfo", {
            params: {
              id: this.courseid,
    ...
    deletecourseinfo() {
      //删除课程信息表操作
      axios
        .get("http://localhost:3000/manager/delcourseinfo", {
    ...
    addclassinfo() {
      ...
      if (
        ...
        axios
          .get("http://localhost:3000/manager/addclassinfo", {
            params: {
    ...
    deleteclassinfo() {
      //删除教师开课表操作
      axios
        .get("http://localhost:3000/manager/delclassinfo", {
          params: {
            id: this.courseid,
            sid: this.staffid,
          },
    ...
    addcsinfo() {
      ...
      if (
        ...
        axios
          .get("http://localhost:3000/manager/addcsinfo", {
            params: {
    ...
    deletecsinfo() {
      //删除选课信息操作
      axios
        .get("http://localhost:3000/manager/delcsinfo", {
          params: {
            sid: this.studentid,
            cid: this.courseid,
          },
    ...
    updatecsinfo() {
      //修改选课表操作
      axios
        .get("http://localhost:3000/manager/updatecsinfo", {
          params: {
            normalscore: this.normalscore,
            testscore: this.testscore,
    ...
    gettotal() {
      axios
        .get("http://localhost:3000/teacher/gettotal")
        .then((res) => {
          //this.info = res.data;
        })
        .catch((err) => {
